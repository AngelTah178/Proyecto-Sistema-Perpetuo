  ...
  <body>
    ...
    <form method="POST">
      ...
      <div class="mb-3">
        ...
        <input type="tel" name="CONTRASEÑA" class="form-control" maxlength="10" oninput="this.value = this.value.replace(/[^0-9]/g, '');" style="border:2px solid #0d2b3e; height:48px;" required>
      </div>
      ...
      <div class="mb-4">
        ...
        <input type="password" name="ESTADO" class="form-control" style="border:2px solid #0d2b3e; height:48px;" required>
      </div>

      <button class="btn py-2" style="background-color:#0d2b3e; color:white; font-weight:700; width:100%; font-size:1.1rem;">
        Registrar usuario
      </button>
